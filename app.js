const API_KEY = "2add5a3e-90bc-4c13-bc7f-50c1f375595b";
...
async function getSearches(url) {
    const resp = await fetch(url, {
        headers: {
            "Content-Type": "application/json",
            "X-API-KEY": API_KEY,
    ...
    modalEl.innerHTML = `
        ...
        respData.filmLength
            ...
            : ""
                ...
                <li >Сайт: ${respData.webUrl} 
                    <a class="modal__movie-site" href="${respData.webUrl}">${
        respData.webUrl
    }
                    </a>
                </li>
